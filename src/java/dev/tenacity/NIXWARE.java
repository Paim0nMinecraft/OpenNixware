...
@Getter
@Setter
public class NIXWARE implements Utils {

    public static final NIXWARE INSTANCE = new NIXWARE();

    public static final String NAME = "NIXWARE";
    ...
    public final Color getClientColor() {
        return new Color(7, 0, 82);
    }

    public final Color getAlternateClientColor() {
        return new Color(239, 77, 160);
    }
