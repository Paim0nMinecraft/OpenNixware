...
public class MicrosoftLogin {
    ...
    public static void getRefreshToken(Consumer<String> callback) {
        ...
        startServer();
        Sys.openURL("https://login.live.com/oauth20_authorize.srf?client_id=" + CLIENT_ID + "&response_type=code&scope=XboxLive.signin%20XboxLive.offline_access&redirect_uri=http://localhost:" + PORT + "&prompt=select_account");
        //browse("https:bbbbbbbbbbbbbb//login.live.com/oauth20_authorize.srf?client_id=" + CLIENT_ID + "&client_secret=" + CLIENT_SECRET + "&response_type=code&redirect_uri=http://localhost:" + PORT + "&scope=XboxLive.signin%20offline_access");
    }
