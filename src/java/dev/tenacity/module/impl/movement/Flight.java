...
public final class Flight extends Module {
    ...
    private final ModeSetting mode = new ModeSetting("Mode", "Watchdog", "Zonecraft", "Watchdog", "Vanilla", "AirWalk", "Viper", "Verus", "Minemen", "Old NCP", "Slime", "Custom", "Packet", "Minemora", "Vulcan","DCJ");
                ...
                if (e.isPre()) {
                    ...
                    if (clipped) {
                        ...
                        if (++canFlyTicks >= 80) {
                            ...
                            PacketUtils.sendPacketNoEvent(new C03PacketPlayer.C04PacketPlayerPosition(p.posX, p.posY + 0.1d, p.posZ, true));
//                                    msg("ground packet");
                            canFlyTicks = 0;
                        }
    ...
    private void onTick(final TickEvent e) {
        if (mc.thePlayer == null) {
            return;
        }
        if (mode.getMode() ==  "DCJ"){
            switch (++watchdogPosYTicks) {
                case 1:
                case 2: {
