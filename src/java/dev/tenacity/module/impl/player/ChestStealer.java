...
public class ChestStealer extends Module {
    ...
    public boolean onMotionEvent(MotionEvent e) {
        if (e.isPre()) {
            ...
            if (invManager == null) invManager = NIXWARE.INSTANCE.getModuleCollection().getModule(InvManager.class);
            if (aura.isEnabled()) {
    ...
    public static boolean canSteal() {
        if (NIXWARE.INSTANCE.isEnabled(ChestStealer.class) && mc.currentScreen instanceof GuiChest) {
            ContainerChest chest = (ContainerChest) mc.thePlayer.openContainer;
            IInventory chestInv = chest.getLowerChestInventory();
