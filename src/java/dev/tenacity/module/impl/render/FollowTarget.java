...
public class FollowTarget extends Module {
    ...
    private final ModeSetting targetHud = new ModeSetting("Mode", "Noraml", "Noraml", "Moon", "Akrien");
    ...
    public FollowTarget() {
        super("FollowTarget", Category.RENDER, "follow the target");
    ...
    private final Dragging drag = NIXWARE.INSTANCE.createDrag(this, "FollowTarget", 300, 300);
    ...
    public void onPreRenderEvent(PreRenderEvent event) {
        ...
        if (killAura == null) {
            killAura = (KillAura) NIXWARE.INSTANCE.getModuleCollection().get(KillAura.class);
        }
