...
public class GlowESP extends Module {
    ...
    private final ColorSetting playerColor = new ColorSetting("Player Color", NIXWARE.INSTANCE.getClientColor());
    private final ColorSetting animalColor = new ColorSetting("Animal Color", NIXWARE.INSTANCE.getAlternateClientColor());
    ...
    private final ShaderUtil outlineShader = new ShaderUtil("nixware/Shaders/outline.frag");
