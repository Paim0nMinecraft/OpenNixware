...
public class NameTags extends Module {
    ...
    private final MultipleBoolSetting nametagSettings = new MultipleBoolSetting("Nametag Settings",
            ...
            new BooleanSetting("Add Shader", false),
    ...
    public NameTags() {
        super("NameTags", Category.RENDER, "Draws a box in 2D space around entitys");
    ...
    public void onShaderEvent(ShaderEvent e) {
        ...
        if (nametagSettings.getSetting("Add Shader").isEnabled() && nametags.isEnabled()) {
            for (Entity entity : entityPosition.keySet()) {
                ...
                if (entity instanceof EntityLivingBase) {
                    AbstractFontRenderer font = csgoFont20;
                    if (mcfont.isEnabled()) {
            ...
            if (entity instanceof EntityLivingBase) {
                ...
                if (nametags.isEnabled()) {
                    ...
                    if (mcfont.isEnabled()) {
                        ...
                        csgoFont20.drawSmoothStringWithShadow(text.toString(), middle, (float) (y - (fontHeight + 5)), healthColor.getRGB());
                    }
                    glPopMatrix();
                }
                ...
                if (itemHeld.isEnabled()) {
                    if (renderingEntity.getHeldItem() != null) {
                        ...
                        if (mcfont.isEnabled()) {
                            ...
                            csgoFont20.drawSmoothStringWithShadow(text, middle, bottom + 4, -1);
                        }
                        glPopMatrix();
                    }
                }
                ...
                if (healthBar.isEnabled()) {
                    ...
                    if (healthBarText.isEnabled()) {
                        ...
                        float fontHeight = mcfont.isEnabled() ? (float) (mc.fontRendererObj.FONT_HEIGHT * fontScale) : (float) (csgoFont20.getHeight() * fontScale);
                        ...
                        if (mcfont.isEnabled()) {
                            ...
                            csgoFont20.drawSmoothStringWithShadow(text, textX, textY, -1);
                        }
                        glPopMatrix();
                    }
