...
public class Radar extends Module {
    ...
    public final Dragging drag = NIXWARE.INSTANCE.createDrag(this, "radar", 5, 40);
    ...
    // 挂在shader event上，把render 2d的图像绘制复制过来，然后在颜色部分改成纯颜色（没有alpha数值），然后他会自己自动模糊（Tenacity写的）
    @Override
