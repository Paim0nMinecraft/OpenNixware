...
public class TargetHUDMod extends Module {
    ...
    private final ModeSetting targetHud = new ModeSetting("Mode", "Noraml", "Moon", "Noraml", "Akrien");
    ...
    private final Dragging drag = NIXWARE.INSTANCE.createDrag(this, "targetHud", 300, 300);
