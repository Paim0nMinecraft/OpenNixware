...
public class AltPanel extends Panel {
    ...
    public void keyTyped(char typedChar, int keyCode) {
        if (NIXWARE.INSTANCE.getAltManager().isTyping()) return;
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        TextField searchField = NIXWARE.INSTANCE.getAltManager().searchField;
        boolean filterBanned = NIXWARE.INSTANCE.getAltManager().filterBanned.isEnabled();
    ...
    public static class AltRect implements Screen {
        ...
        public void drawScreen(int mouseX, int mouseY) {
            ...
            switch (alt.getType()) {
                ...
                case "Mojang":
                    ...
                    mc.getTextureManager().bindTexture(new ResourceLocation("nixware/mojang.png"));
                    Gui.drawModalRectWithCustomSizedTexture(typeX + 2, usernameY - 1, 0, 0, size, size, size, size);
                    RenderUtil.resetColor();
                    break;
                case "Cracked":
                    Color red = NIXWARE.INSTANCE.getSideGui().getRedBadColor();
            ...
            if (NIXWARE.INSTANCE.getAltManager().currentSessionAlt == alt) {
                Color green = NIXWARE.INSTANCE.getSideGui().getGreenEnabledColor();
        ...
        public void drawAltHead(float x, float y, float size) {
            NIXWARE.INSTANCE.getAltManager().getUtils().getHead(alt);
            GLUtil.startBlend();
            RenderUtil.setAlphaLimit(0);
            mc.getTextureManager().bindTexture(alt.head != null ? alt.head : new ResourceLocation("nixware/X-Steve.png"));
