...
public class ModuleRect implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        boolean hoveringText = HoveringUtil.isHovering(x + 5, y + csgoFont18.getMiddleOfBox(height), csgoFont18.getStringWidth(module.getName()), csgoFont18.getHeight(), mouseX, mouseY);
        ...
        csgoFont18.drawString((module.isEnabled() ? "§l" : "") + module.getName(), x + 5, y + csgoFont18.getMiddleOfBox(height), moduleTextColor);
