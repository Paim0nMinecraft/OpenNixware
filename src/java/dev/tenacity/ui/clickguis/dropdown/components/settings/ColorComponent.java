...
public class ColorComponent extends SettingComponent<ColorSetting> {
    ...
    private final TextField hexField = new TextField(FontUtil.csgoFont16);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        csgoFont16.drawString(colorSetting.name, x + 5, y + csgoFont16.getMiddleOfBox(realHeight), textColor);
        ...
        csgoFont14.drawCenteredStringWithShadow(text, colorX + colorWidth / 2f,
                colorY + csgoFont14.getMiddleOfBox(colorHeight),
        ...
        if (opened || !openAnimation.isDone()) {
            ...
            GLUtil.startBlend();
            RenderUtil.drawImage(new ResourceLocation("nixware/colorpicker2.png"), pickerX, pickerY, 4, 4);
            GLUtil.endBlend();

            float hueY = gradientY + gradientHeight + 5;
            float hueHeight = 4;
            RenderUtil.resetColor();
            mc.getTextureManager().bindTexture(new ResourceLocation("nixware/hue.png"));
            ...
            if (!rainbowAnimation.finished(Direction.FORWARDS)) {
                ...
                csgoFont16.drawString("Hex", gradientX, newYVal + csgoFont16.getMiddleOfBox(heightLeft), whiteColor);
                ...
                if (!hexField.isFocused()) {
                    ...
                    try {
                        ...
                        csgoFont14.drawString("Invalid Hex Code", hexField.getXPosition() - .5f, newYVal - (csgoFont14.getHeight() - .5f),
