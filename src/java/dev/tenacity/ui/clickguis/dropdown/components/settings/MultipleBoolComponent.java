...
public class MultipleBoolComponent extends SettingComponent<MultipleBoolSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        csgoFont14.drawString(getSetting().name, x + 6, y + 4, textColor);
        ...
        for (BooleanSetting setting : sortedSettings) {
            ...
            float enabledHeight = csgoFont14.getHeight() + 4;
            ...
            csgoFont14.drawString(setting.name, enabledX + 2, enabledY + 2,
    ...
    private float getEnabledWidth(BooleanSetting setting) {
        return (csgoFont14.getStringWidth(setting.name) + 4);
    }
