...
public class NumberComponent extends SettingComponent<NumberSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        float funnyWidth = (csgoFont16.getStringWidth(numberSetting.name) - (csgoFont16.getStringWidth(": " + value)));
        csgoFont16.drawString(": §l" + value, sliderX +
                        funnyWidth + (csgoFont16.getStringWidth(": " + value) * firstTextAnim),
        ...
        csgoFont16.drawString(numberSetting.name, sliderX, y + 2, textColor);
