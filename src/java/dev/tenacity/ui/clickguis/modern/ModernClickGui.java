...
public class ModernClickGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        ClickGUIMod clickMod = NIXWARE.INSTANCE.getModuleCollection().getModule(ClickGUIMod.class);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (ModuleCollection.reloadModules || moduleRects == null) {
            ...
            for (Category category : Category.values()) {
                ...
                for (Module module : NIXWARE.INSTANCE.getModuleCollection().getModulesInCategory(category)) {
        ...
        typing = modpanel.isTyping() || (NIXWARE.INSTANCE.getSideGui().isFocused() && NIXWARE.INSTANCE.getSideGui().isTyping()) || NIXWARE.INSTANCE.getSearchBar().isTyping();

        if (ClickGUIMod.walk.isEnabled() && !typing) {
            Inventory.updateStates();
        }

        boolean focusedConfigGui = NIXWARE.INSTANCE.getSideGui().isFocused();
        ...
        boolean searching = NIXWARE.INSTANCE.getSearchBar().isFocused();
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("nixware/modernlogo.png"));
        ...
        FontUtil.tenacityFont20.drawString("NIXWARE", x + 35 + xAdjust, y + 13, -1);

        FontUtil.tenacityFont14.drawString(NIXWARE.VERSION, x + 41 + FontUtil.tenacityFont18.getStringWidth("NIXWARE") + xAdjust, y + 15.5f,
                new Color(98, 98, 98));
