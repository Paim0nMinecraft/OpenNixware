...
public class ParticleEngine implements Utils {
    ...
    public ParticleEngine() {
        ...
        particleImages.add(new ParticleImage(9, Pair.of(320, 432)));
        particleImages.add(new ParticleImage(10, Pair.of(427, 208)));
        particleImages.add(new ParticleImage(11, Pair.of(748, 431)));
        particleImages.add(new ParticleImage(12, Pair.of(555, 433)));
        particleImages.add(new ParticleImage(13, Pair.of(441, 405)));
        particleImages.add(new ParticleImage(14, Pair.of(430, 429)));
        particleImages.add(new ParticleImage(15, Pair.of(433, 416)));
    }
