package dev.tenacity.ui.musicplayer.cloudmusic;
...
public class MusicManager extends ListenerAdapter {
    ...
    public MusicManager() {
        ...
        circleImage = new File(Minecraft.getMinecraft().mcDataDir.toString() + File.separator + NIXWARE.NAME + File.separator + "circleImage");
