package dev.tenacity.ui.musicplayer.cloudmusic.ui;
...
public class MusicOverlayRenderer {
    ...
    private final AbstractFontRenderer fontRenderer = dev.tenacity.utils.font.hanabi.FontUtil.getFromCustomFont(dev.tenacity.utils.font.FontUtil.tenacityFont18);
    ...
    public void renderOverlay(float x, float y) {
        ...
        if (MusicManager.INSTANCE.getCurrentTrack() != null && MusicManager.INSTANCE.getMediaPlayer() != null) {
            dev.tenacity.utils.font.hanabi.FontUtil.getFromCustomFont(dev.tenacity.utils.font.FontUtil.tenacityFont18).drawString(MusicManager.INSTANCE.getCurrentTrack().name + " - " + MusicManager.INSTANCE.getCurrentTrack().artists, x + 32, y + 5, Color.WHITE.getRGB());
            dev.tenacity.utils.font.hanabi.FontUtil.getFromCustomFont(dev.tenacity.utils.font.FontUtil.tenacityFont18).drawString(formatSeconds((int) readSecs) + "/" + formatSeconds((int) totalSecs), x + 32, y + 15, 0xffffffff);
        ...
        if (MusicManager.INSTANCE.lyric) {
            ...
            dev.tenacity.utils.font.hanabi.FontUtil.getFromCustomFont(dev.tenacity.utils.font.FontUtil.tenacityFont18).drawString(s, (sr.getScaledWidth() - fontRenderer.getStringWidth(s)) / 2f, sr.getScaledHeight() - 40 - 10, col, true);
            s = MusicManager.INSTANCE.tlrcCur.contains("_EMPTY_") ? "Waiting......." : MusicManager.INSTANCE.tlrcCur;
            dev.tenacity.utils.font.hanabi.FontUtil.getFromCustomFont(dev.tenacity.utils.font.FontUtil.tenacityFont18).drawString(s, (sr.getScaledWidth() - fontRenderer.getStringWidth(s)) / 2f, sr.getScaledHeight() - 30 - 10, col, true);
