...
public class TrackSlot {
    ...
    public void draw(float x, float y, float mouseX, float mouseY) {
        ...
        this.x = x;
        this.y = y;
        AbstractFontRenderer font = dev.tenacity.utils.font.hanabi.FontUtil.getFromCustomFont(dev.tenacity.utils.font.FontUtil.tenacityFont18);
        RoundedUtil.drawRound(x, y, width, height, 4, boxColor);
        GradientUtil.applyGradientHorizontal((int) (x + 2), (int) (y + 1), font.getStringWidth(track.name), font.getHeight(), 1, NIXWARE.INSTANCE.getClientColor(), NIXWARE.INSTANCE.getAlternateClientColor(), () ->
