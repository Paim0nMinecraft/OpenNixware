...
public class ShaderProgram {
    ...
    private static String readShader(String fileName) {
        ...
        try {
            final InputStreamReader inputStreamReader = new InputStreamReader(Objects.requireNonNull(ShaderProgram.class.getClassLoader().getResourceAsStream(String.format("assets/minecraft/novo/shaders/%s", fileName))));
