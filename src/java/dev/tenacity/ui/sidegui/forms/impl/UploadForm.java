...
public class UploadForm extends Form {
    ...
    private final TextField nameField = new TextField(csgoFont18);
    private final TextField descriptionField = new TextField(csgoFont18);
    private final TextField serverField = new TextField(csgoFont18);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        csgoFont16.drawString("To upload your " + type.toLowerCase() + " you must provide some information",
                infoX, infoY, ColorUtil.applyOpacity(getTextColor(), .5f));

        infoY += csgoFont16.getHeight() + 3;

        csgoFont16.drawString("All fields are §lrequired", infoX, infoY, ColorUtil.applyOpacity(getTextColor(), .5f));
        ...
        csgoFont24.drawString(type + " name", nameField.getXPosition(),
        ...
        if (type.equals("Config")) {
            ...
            csgoFont24.drawString("Server IP", serverField.getXPosition(),
                    serverField.getYPosition() - (csgoFont24.getHeight() + 5), getTextColor());

            csgoFont14.drawCenteredString("Input the IP of the server the config was made for",
        ...
        csgoFont24.drawString("Description", descriptionField.getXPosition(),
                descriptionField.getYPosition() - (csgoFont24.getHeight() + 5), getTextColor());
        ...
        if (error) {
            csgoFont16.drawCenteredStringWithShadow("Error please fill out the required fields",
                    uploadButton.getX() + uploadButton.getWidth() / 2f, uploadButton.getY() - (csgoFont16.getHeight() + 5),
