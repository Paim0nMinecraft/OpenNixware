    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (!openAnimation.isDone() || opened) {
            ...
            for (String option : options) {
                ...
                csgoFont18.drawString(option, getX() + 5, dropdownY + seperation + csgoFont18.getMiddleOfBox(getHeight()),
        ...
        csgoFont18.drawString("§l" + name + ":§r " + selection, getX() + 4, getY() + csgoFont18.getMiddleOfBox(getHeight()), textColor);
