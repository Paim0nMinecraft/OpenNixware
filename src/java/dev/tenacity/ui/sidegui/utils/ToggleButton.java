...
public class ToggleButton implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        csgoFont16.drawString(name, x - (csgoFont16.getStringWidth(name) + 5), y + csgoFont16.getMiddleOfBox(WH), textColor);
        ...
        Color roundColor = ColorUtil.interpolateColorC(ColorUtil.tripleColor(64), NIXWARE.INSTANCE.getSideGui().getGreenEnabledColor(), toggleAnim);
    ...
    public float getActualX() {
        return x - ((csgoFont16.getStringWidth(name) + 5));
    }
