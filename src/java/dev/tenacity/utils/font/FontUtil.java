...
import dev.tenacity.utils.font.hanabi.RendererInterface;
...
public class FontUtil implements Utils {
    ...
    public static AbstractFontRenderer icon2 = dev.tenacity.utils.font.hanabi.FontUtil.icon35;
...
//            ms = icon2 + "b";
    ...
    public enum FontType {
        TENACITY("tenacity", "tenacity-bold", 12, 14, 16, 18, 20, 22, 24, 26, 28, 32,36, 40, 80),
        ARIAL("arial", 12, 14, 16, 18, 20, 24, 26, 30, 32, 35, 40, 45, 50, 55, 60),
        TAHOMA("tahoma", "tahoma-bold", 10, 12, 14, 16, 18, 27),
        RUBIK("rubik", "rubik-bold", 13, 18),
        NEVERLOSE("neverlose", 12, 16, 17, 18, 22),
        CSGO("csgo", 12, 14, 16, 17, 18, 20, 22, 24, 26, 30, 32, 35, 40, 45, 50, 55, 60),
        EXHI("exhi", 12, 14, 16, 17, 18, 20, 22, 24, 26, 30, 32, 35, 40, 45, 50, 55, 60),
        WATER("water", 16, 18, 20, 26, 30, 32, 35, 40, 45, 50, 55, 60, 100),
        BIG("big", 16, 17, 18, 19, 20, 22, 24, 26, 30, 32, 35, 40, 45, 50, 55, 60),
        MICON("micon", 16, 20, 26, 35, 40),
        OXIDE("oxide", 12, 14, 16, 17, 18, 20, 22, 24, 26, 30, 32, 35, 40, 45, 50, 55, 60),
        ICON("icon", 16, 20, 26, 35, 40),
        ICON2("icon2", 16, 20, 26, 35, 40);
        ...
        FontType(String fontName, String boldName, int... sizes) {
            this.location = new ResourceLocation("nixware/Fonts/" + fontName + ".ttf");
            this.boldLocation = new ResourceLocation("nixware/Fonts/" + boldName + ".ttf");
            this.sizes = sizes;
        }
