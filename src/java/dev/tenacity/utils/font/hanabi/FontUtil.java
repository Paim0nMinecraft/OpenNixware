...
public class FontUtil {
    public static AbstractFontRenderer tenacityFont24 = new RendererInterface("tenacity.ttf", 24);
    ...
    public static AbstractFontRenderer icon35 = new RendererInterface("icon2.ttf", 35);
