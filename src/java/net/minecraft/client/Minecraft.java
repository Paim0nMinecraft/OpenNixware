...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        this.gameSettings.guiScale = 2;
        SoundUtils.playSound(new ResourceLocation("nixware/Sounds/opening.wav"), .8f);
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("nixware>dev for minecraft 1.8");
//        Display.setTitle("NIXWARE For Minecraft 1.8 LWJGL " + Sys.getVersion());
    ...
    private void runGameLoop() throws IOException {
        ...
        if (!this.skipRenderWorld) {
            ...
            NIXWARE.INSTANCE.getEventProtocol().handleEvent(renderTickEvent);
    ...
    public void shutdown() {
        NIXWARE.INSTANCE.getEventProtocol().handleEvent(new GameCloseEvent());
        this.running = false;
    }
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0) {
            ...
            NIXWARE.INSTANCE.getEventProtocol().handleEvent(e);
...
//                        this.playerController.attackEntity(this.thePlayer, this.objectMouseOver.entityHit);
    ...
    public void rightClickMouse() {
        NIXWARE.INSTANCE.getEventProtocol().handleEvent(new ClickEventRight());
    ...
    public void runTick() throws IOException {
        ...
        NIXWARE.INSTANCE.getEventProtocol().handleEvent(tickEvent);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        NIXWARE.INSTANCE.getEventProtocol().handleEvent(new KeyPressEvent(k));
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                NIXWARE.INSTANCE.getEventProtocol().handleEvent(blockEvent);
            ...
            NIXWARE.INSTANCE.getEventProtocol().handleEvent(new BlockPlaceableEvent());
