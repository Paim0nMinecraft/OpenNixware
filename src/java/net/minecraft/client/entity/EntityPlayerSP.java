...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        NIXWARE.INSTANCE.getEventProtocol().handleEvent(new UpdateEvent());
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            NIXWARE.INSTANCE.getEventProtocol().handleEvent(motionEvent);
    ...
    public void sendChatMessage(String message) {
        if (NIXWARE.INSTANCE.getCommandHandler().execute(message) || message.startsWith(CommandHandler.CHAT_PREFIX)) {
            return;
        }

        PlayerSendMessageEvent playerSendMessageEvent = new PlayerSendMessageEvent(message);
        NIXWARE.INSTANCE.getEventProtocol().handleEvent(playerSendMessageEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        NIXWARE.INSTANCE.getEventProtocol().handleEvent(pushOutOfBlockEvent);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            ...
            NIXWARE.INSTANCE.getEventProtocol().handleEvent(slowDownEvent);
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        NIXWARE.INSTANCE.getEventProtocol().handleEvent(event);
    ...
    public void jump() {
        ...
        NIXWARE.INSTANCE.getEventProtocol().handleEvent(jumpEvent);
