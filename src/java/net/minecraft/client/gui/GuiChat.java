...
public class GuiChat extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (spotifyMod == null) {
            spotifyMod = (SpotifyMod) NIXWARE.INSTANCE.getModuleCollection().get(SpotifyMod.class);
            arraylistMod = (ArrayListMod) NIXWARE.INSTANCE.getModuleCollection().get(ArrayListMod.class);
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (HUDMod.customFont.isEnabled()) {
            abstractFontRenderer = dev.tenacity.utils.font.hanabi.FontUtil.getFromCustomFont(FontUtil.bigFont16);
        }
        ...
        HUDMod hudMod = (HUDMod) NIXWARE.INSTANCE.getModuleCollection().get(HUDMod.class);
        ...
        Color color = ColorUtil.interpolateColorsBackAndForth(15, 1, new Color(0,0,0, 128), new Color(255,255,255,15), false);
        RoundedUtil.drawRoundOutline(width / 2f - 50, 20, 100, 20, 0, 2,
                new Color(40, 40, 40, (int) (255 * alpha)), color);

        FontUtil.tenacityBoldFont20.drawCenteredString("Reset HUD", width / 2f, 20 + FontUtil.tenacityBoldFont20.getMiddleOfBox(20), -1);
