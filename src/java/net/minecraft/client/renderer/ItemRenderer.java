...
public class ItemRenderer {
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress) {
        boolean animations = NIXWARE.INSTANCE.isEnabled(Animations.class);
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            if (NIXWARE.INSTANCE.isEnabled(Animations.class)) {
                                switch (Animations.mode.getMode()) {
                                    ...
                                    case "Custom":
                                        ...
                                        NIXWARE.INSTANCE.getEventProtocol().handleEvent(blockRenderEvent);
                                        break;
                                }
                            } else {
                                this.transformFirstPersonItem(f, 0.0F);
