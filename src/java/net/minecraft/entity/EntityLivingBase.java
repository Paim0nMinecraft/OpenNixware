...
public abstract class EntityLivingBase extends Entity {
    ...
    public void onDeath(DamageSource cause) {
        ...
        if (entity != null) {
            if (entity instanceof EntityLivingBase) {
                NIXWARE.INSTANCE.getEventProtocol().handleEvent(new LivingDeathEvent(this, cause));
            }
    ...
    private int getArmSwingAnimationEnd() {
        return (NIXWARE.INSTANCE.getModuleCollection().get(Animations.class).isEnabled() ? Animations.slowdown.getValue().intValue() : 1)
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            ...
            if (this instanceof EntityPlayerSP) {
                NIXWARE.INSTANCE.getEventProtocol().handleEvent(jumpFixEvent);
            }
